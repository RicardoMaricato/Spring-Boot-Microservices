package br.com.ricardo.microservices.security.token.creator;
...
public class TokenCreator {
    ...
    @SneakyThrows
    public SignedJWT createSignedJWT(org.springframework.security.core.Authentication auth) {
    ...
    private JWTClaimsSet createJWTClaimSet(Authentication auth, ApplicationUser applicationUser) {
        ...
        return new JWTClaimsSet.Builder()
                ...
                .claim("authorities", auth.getAuthorities()
                        ...
                        .collect(toList()))
                .issuer("https://github.com/RicardoMaricato")
                .issueTime(new Date())
